...
CREATE OR REPLACE FUNCTION protra.f_lista_funcionario_wf_sol (
...
***************************************************************************
 SCRIPT:        protra.f_lista_funcionario_wf_sol
 DESCRIPCIÓN:
 AUTOR:  		EGS
 FECHA:
 COMENTARIOS:
...
BEGIN
    v_nombre_funcion ='protra.f_lista_funcionario_wf_sol';
          select
           estwf.id_proceso_wf
          into
            v_id_proceso_wf
