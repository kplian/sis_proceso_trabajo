CREATE OR REPLACE FUNCTION "protra"."ft_aperturas_digitales_det_ime"(p_administrador integer, p_id_usuario integer,
    ...
    ***********************************/
    ...
    if (p_transaccion = 'PROTRA_ADIGD_INS') then
        ...
        begin
            ...
            insert into protra.taperturas_digitales_det(estado_reg,
                                                        obs_dba,
                                                        uid_email,
                                                        numero_email,
                                                        remitente_email,
            ...
            v_resp = pxp.f_agrega_clave(v_resp, 'mensaje',
                                        'Aperturas digitales Detalle almacenado(a) con exito (id_apertura_digital_det' ||
                                        v_id_apertura_digital_det || ')');
        ...
        ***********************************/
        ...
        begin
            ...
            update protra.taperturas_digitales_det
            set uid_email             = v_parametros.uid_email,
            ...
            v_resp = pxp.f_agrega_clave(v_resp, 'id_apertura_digital_det',
                                        v_parametros.id_apertura_digital_det::varchar);
        ...
        ***********************************/
        ...
        begin
            ...
            delete
            from protra.taperturas_digitales_det
            where id_apertura_digital_det = v_parametros.id_apertura_digital_det;
