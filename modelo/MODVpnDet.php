...
class MODVpnDet extends MODbase{
	...
	function listarVpnDet(){
		...
		$this->procedimiento='protra.ft_vpn_det_sel';
		$this->transaccion='PROTRA_VPNDET_SEL';
		$this->tipo_procedimiento='SEL';//tipo de transaccion
				
		//Definicion de la lista del resultado del query
		$this->captura('id_vpn_det','int4');
