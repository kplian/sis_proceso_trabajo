...
/**
 * @package pXP
 * @file AperturasDigitalesDetNoAceptados.php
 * @author  (valvarado)
...
?>
<script>
    Phx.vista.AperturasDigitalesDetNoAceptados = {
        ...
        constructor: function (config) {
            ...
            Phx.vista.AperturasDigitalesDetNoAceptados.superclass.constructor.call(this, config);
            this.init();
        },
